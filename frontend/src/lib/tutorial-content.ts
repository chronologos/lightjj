...
export const FEATURES: TutorialFeature[] = [
  ...
  { version: '1.5.0', shortcut: null, title: 'Per-gap context expansion', description: 'Click any "\u00b7\u00b7\u00b7 N lines" button between hunks to reveal just that gap \u2014 adjacent hunks merge as you expand. Right-click \u2192 "Expand full context" still reveals everything at once.' },
  { version: '1.5.0', shortcut: null, title: 'Sharper graph, consistent UI', description: 'SVG graph lines now render pixel-crisp (2px stroke, crispEdges on axis-aligned lines). Buttons, toggles, modals, and panel headers use shared primitives \u2014 no more per-component drift. Soft-wrapped diff lines keep the gutter clear.' },
]
