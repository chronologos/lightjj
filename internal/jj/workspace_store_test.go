...
func TestParseWorkspaceStorePaths_MultipleWorkspaces(t *testing.T) {
	data := append(buildEntry("default", "/home/alice/src/lightjj"), buildEntry("base2", "/home/alice/src/lightjj/base2")...)
	result, err := ParseWorkspaceStorePaths(data)
	require.NoError(t, err)
	assert.Equal(t, map[string]string{
		"default": "/home/alice/src/lightjj",
		"base2":   "/home/alice/src/lightjj/base2",
	}, result)
}
